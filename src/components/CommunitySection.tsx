...
const CommunitySection = () => {
  return <section id="community" className="py-20 bg-gradient-to-br from-black via-gray-800 to-meme-gold relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <Card className="bg-gradient-to-br from-purple-600 to-purple-800 border-4 border-meme-gold shadow-2xl transform hover:scale-105 transition-all duration-300">
            <CardContent className="p-8 text-center">
              ...
              <Button className="bg-white hover:bg-gray-200 text-purple-600 font-bold" onClick={() => window.open('https://discord.gg/8b5YDW62D4', '_blank')}>
                Join Discord
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-blue-500 to-blue-700 border-4 border-meme-gold shadow-2xl transform hover:scale-105 transition-all duration-300">
            <CardContent className="p-8 text-center">
              ...
              <Button className="bg-white hover:bg-gray-200 text-blue-600 font-bold" onClick={() => window.open('https://x.com/Get_Ivanka_Meme', '_blank')}>
                Follow on X
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-orange-600 to-red-600 border-4 border-meme-gold shadow-2xl transform hover:scale-105 transition-all duration-300">
            <CardContent className="p-8 text-center">
              ...
              <Button className="bg-white hover:bg-gray-200 text-orange-600 font-bold" onClick={() => window.open('https://www.reddit.com/user/Get_IvankaCoin/', '_blank')}>
                Join Reddit
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-blue-600 to-blue-800 border-4 border-meme-gold shadow-2xl transform hover:scale-105 transition-all duration-300">
            <CardContent className="p-8 text-center">
              ...
              <Button className="bg-white hover:bg-gray-200 text-blue-600 font-bold" onClick={() => window.open('https://t.me/ivankaofficiall', '_blank')}>
                Join Telegram
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-green-600 to-green-800 border-4 border-meme-gold shadow-2xl transform hover:scale-105 transition-all duration-300">
            <CardContent className="p-8 text-center">
              ...
              <Button className="bg-white hover:bg-gray-200 text-green-600 font-bold" onClick={() => window.open('https://chat.whatsapp.com/LawvBYPEIevKhNk3TjpTJT', '_blank')}>
                Join WhatsApp
              </Button>
            </CardContent>
          </Card>
      ...
      {/* PepeIvanka positioned at bottom left of community section */}
      <div className="absolute bottom-8 left-8 animate-wiggle z-20">
