...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-transparent">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between relative z-10 bg-transparent">
        ...
        <div className="md:hidden">
          <Button
            ...
            className="text-white hover:text-meme-gold"
          >
        ...
        <div className="md:hidden absolute top-full left-0 right-0 bg-black/80 backdrop-blur-lg z-40">
          <div className="container mx-auto px-4 py-6">
            ...
            <div className="space-y-4 mb-6">
              <button 
                onClick={() => handleNavClick('about')}
                className="block w-full text-left text-white font-bold hover:text-meme-gold transition-colors py-2"
              >
                About
              </button>
              <button 
              ...
              <button 
                onClick={() => handleLinkClick('/how-to-buy')}
                className="block w-full text-left text-white font-bold hover:text-meme-gold transition-colors py-2"
              >
                How to Buy
              </button>
